...
if [[ "$ENVIRONMENT" == "production" ]]; then
    BASE_URL="https://semanticinfrastructurefoundation.org"
elif [[ "$ENVIRONMENT" == "staging" ]]; then
    BASE_URL="https://sif-staging.mytia.net"
else
...
echo ""
echo -e "${CYAN}╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║       SIF Website - Smoke Test Suite                    ║${NC}"
echo -e "${CYAN}╚══════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if [[ $FAIL -eq 0 ]]; then
    ...
    echo "  1. Check container logs: ssh $HOST 'podman logs sif-website'"
